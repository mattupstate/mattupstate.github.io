...
1. [High Level Concepts](#s1)
    - [Platform vs Application](#s1a)
    - [A Flask application is a collection of views, extensions, and configuration](#s1b)
    - [Application logic is structured in logical packages and exposes an API of its own](#s1c)
    - [View functions are the layer between an HTTP request and the application logic](#s1d)
2. [Patterns and Conventions](#s2)
    - [Application Factories](#s2a)
    - [Blueprints](#s2b)
    - [Services](#s2c)
	- [API Errors/Exceptions](#s2d)
	- [View Decorators](#s2e)
	- [Middlware](#s2f)
	- [JSON Serialization](#s2g)
